        ...
        describe("Can contain views") {
            ...
            describe("-layoutSubviews") {
                describe("should layout view1") {
                    ...
                    it("should set x") {
                        expect(view1.frame.origin.x).to(equal(rect.origin.x))
                    }
                    it("should set y") {
                        expect(view1.frame.origin.y).to(equal(rect.origin.y))
                    }
                    it("should set width") {
                        expect(view1.frame.size.width).to(equal(rect.size.width))
                    }
                    it("should set height") {
                        expect(view1.frame.size.height).to(equal(rect.size.height))
                    }
                }
                describe("should layout view2") {
                    ...
                    it("should set x") {
                        expect(view2.frame.origin.x).to(equal(rect.origin.x))
                    }
                    it("should set y") {
                        expect(view2.frame.origin.y).to(equal(rect.origin.y))
                    }
                    it("should set width") {
                        expect(view2.frame.size.width).to(equal(rect.size.width))
                    }
                    it("should set height") {
                        expect(view2.frame.size.height).to(equal(rect.size.height))
                    }
                }
                describe("should layout view3") {
                    ...
                    it("should set x") {
                        expect(view3.frame.origin.x).to(equal(rect.origin.x))
                    }
                    it("should set y") {
                        expect(view3.frame.origin.y).to(equal(rect.origin.y))
                    }
                    it("should set width") {
                        expect(view3.frame.size.width).to(equal(rect.size.width))
                    }
                    it("should set height") {
                        expect(view3.frame.size.height).to(equal(rect.size.height))
                    }
                }
            }
        }
