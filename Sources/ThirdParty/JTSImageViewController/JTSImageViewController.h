...
typedef NS_OPTIONS(NSInteger, JTSImageViewControllerBackgroundOption) {
...
@property (assign, nonatomic, readonly) JTSImageViewControllerBackgroundOption backgroundOptions;
...
- (instancetype)initWithImageInfo:(JTSImageInfo *)imageInfo
                  ...
                  backgroundStyle:(JTSImageViewControllerBackgroundOption)backgroundOptions;
